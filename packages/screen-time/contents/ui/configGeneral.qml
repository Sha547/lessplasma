...
Kirigami.FormLayout {
    ...
    property alias cfg_topCount: topCountSpin.value
    property alias cfg_chartCapMinutes: chartCapSpin.value
    property alias cfg_maxCategoryChips: maxChipsSpin.value
    ...
    QQC2.SpinBox {
        id: topCountSpin
        Kirigami.FormData.label: "Top apps shown:"
        from: 1
        to: 6
    }
    ...
    QQC2.SpinBox {
        id: chartCapSpin
        Kirigami.FormData.label: "Chart axis cap (min):"
        from: 10
        to: 60
    }
    ...
    QQC2.SpinBox {
        id: maxChipsSpin
        Kirigami.FormData.label: "Category chips shown:"
        from: 1
        to: 6
    }
